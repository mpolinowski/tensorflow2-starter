...
# Project Setup
MODEL_ZOO = 'https://github.com/tensorflow/models'
GenerateTFRecord = 'https://github.com/mpolinowski/GenerateTFRecord'
...
if not os.path.exists(os.path.join(paths['APIMODEL_PATH'], 'research', 'object_detection')):
    os.system('git clone ' + MODEL_ZOO + ' ./' + paths['APIMODEL_PATH'])

# Install Tensorflow Object Detection
os.system('cd Tensorflow/models/research && protoc object_detection/protos/*.proto --python_out=. && cp '
...
if not os.path.exists(files['TF_RECORD_SCRIPT']):
    os.system('git clone ' + GenerateTFRecord + ' ./' + paths['SCRIPTS_PATH'])
...
training_command = "python {} --model_dir={} --pipeline_config_path={} --num_train_steps=10000".format(
